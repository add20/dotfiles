...
DOT_FILES=( .tmux.conf .zsh .zshrc .zshenv .gemrc .bundle .gitconfig .gitattribues .gitignore .agignore .inputrc .vimrc .gvimrc .vim .emacs .sqliterc .ghci .pandoc .stylish-haskell.yaml .hirc)
